...
/**
 * Sprint 22 — shared secret-redaction for the sales pipeline services.
 *
 * Sales pipeline records may hold free-text (lead notes, activity notes, risk
 * descriptions, signoff notes). No such field may ever leak a credential, payment
 * gateway secret, server password, CRM/API token, or a live analytics / ad pixel
 * token. This trait strips `key: value` secret patterns from strings and redacts
 * secret-looking keys from metadata arrays.
 */
trait SanitizesSalesPipelineText
{
