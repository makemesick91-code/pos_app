...
class AdminAuditLog extends Model
{
    ...
    // Sprint 24 — subscription renewal & dunning governance.
    public const ACTION_RENEWAL_POLICY_CREATED = 'RENEWAL_POLICY_CREATED';
    public const ACTION_RENEWAL_POLICY_UPDATED = 'RENEWAL_POLICY_UPDATED';
    public const ACTION_RENEWAL_POLICY_DEFAULT_ENSURED = 'RENEWAL_POLICY_DEFAULT_ENSURED';
    public const ACTION_RENEWAL_RUN_CREATED = 'RENEWAL_RUN_CREATED';
    public const ACTION_RENEWAL_RUN_EVALUATED = 'RENEWAL_RUN_EVALUATED';
    public const ACTION_RENEWAL_RUN_COMPLETED = 'RENEWAL_RUN_COMPLETED';
    public const ACTION_RENEWAL_CANDIDATE_UPDATED = 'RENEWAL_CANDIDATE_UPDATED';
    public const ACTION_RENEWAL_CANDIDATE_READY = 'RENEWAL_CANDIDATE_READY';
    public const ACTION_RENEWAL_CANDIDATE_GRACE_REVIEW = 'RENEWAL_CANDIDATE_GRACE_REVIEW';
    public const ACTION_RENEWAL_CANDIDATE_OVERDUE_REVIEW = 'RENEWAL_CANDIDATE_OVERDUE_REVIEW';
    public const ACTION_RENEWAL_CANDIDATE_DO_NOT_RENEW = 'RENEWAL_CANDIDATE_DO_NOT_RENEW';
    public const ACTION_DUNNING_NOTICE_PREPARED = 'DUNNING_NOTICE_PREPARED';
    public const ACTION_DUNNING_NOTICE_MARKED_PREPARED = 'DUNNING_NOTICE_MARKED_PREPARED';
    public const ACTION_DUNNING_NOTICE_MARKED_SENT_MANUALLY = 'DUNNING_NOTICE_MARKED_SENT_MANUALLY';
    public const ACTION_DUNNING_NOTICE_COMPLETED = 'DUNNING_NOTICE_COMPLETED';
    public const ACTION_DUNNING_NOTICE_CANCELLED = 'DUNNING_NOTICE_CANCELLED';
    public const ACTION_DUNNING_NOTICE_SKIPPED = 'DUNNING_NOTICE_SKIPPED';
    public const ACTION_RENEWAL_DECISION_RECORDED = 'RENEWAL_DECISION_RECORDED';
    public const ACTION_RENEWAL_DECISION_VOIDED = 'RENEWAL_DECISION_VOIDED';
    public const ACTION_RENEWAL_DECISION_APPLIED_MANUALLY = 'RENEWAL_DECISION_APPLIED_MANUALLY';
    public const ACTION_RENEWAL_ACTIVITY_CREATED = 'RENEWAL_ACTIVITY_CREATED';
    public const ACTION_RENEWAL_ACTIVITY_COMPLETED = 'RENEWAL_ACTIVITY_COMPLETED';
    public const ACTION_RENEWAL_ACTIVITY_CANCELLED = 'RENEWAL_ACTIVITY_CANCELLED';
    public const ACTION_RENEWAL_RISK_CREATED = 'RENEWAL_RISK_CREATED';
    public const ACTION_RENEWAL_RISK_UPDATED = 'RENEWAL_RISK_UPDATED';
    public const ACTION_RENEWAL_RISK_ACCEPTED = 'RENEWAL_RISK_ACCEPTED';
    ...
    // Sprint 24 — subscription renewal & dunning governance.
    public const TARGET_SUBSCRIPTION_RENEWAL_POLICY = 'subscription_renewal_policy';
    public const TARGET_SUBSCRIPTION_RENEWAL_RUN = 'subscription_renewal_run';
    public const TARGET_SUBSCRIPTION_RENEWAL_CANDIDATE = 'subscription_renewal_candidate';
    public const TARGET_SUBSCRIPTION_DUNNING_NOTICE = 'subscription_dunning_notice';
    public const TARGET_SUBSCRIPTION_RENEWAL_DECISION = 'subscription_renewal_decision';
    public const TARGET_SUBSCRIPTION_RENEWAL_ACTIVITY = 'subscription_renewal_activity';
    public const TARGET_SUBSCRIPTION_RENEWAL_RISK = 'subscription_renewal_risk';
    public const TARGET_SUBSCRIPTION_RENEWAL_SIGNOFF = 'subscription_renewal_signoff';
