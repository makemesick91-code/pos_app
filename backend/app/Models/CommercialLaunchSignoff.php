...
/**
 * A commercial launch signoff (Sprint 20). A preserved sign-off record for a
 * commercial launch run. A REJECTED signoff forces NO-GO; an APPROVED_WITH_RISK
 * signoff forces WATCH. Records are never deleted and never carry secrets.
 */
class CommercialLaunchSignoff extends Model
{
