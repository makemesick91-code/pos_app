...
/**
 * A preserved sales pipeline sign-off record (Sprint 22). A REJECTED signoff
 * forces NO-GO; an APPROVED_WITH_RISK signoff forces WATCH. Records are never
 * deleted and never carry secrets.
 */
class SalesPipelineSignoff extends Model
{
    ...
    public const ROLE_ONBOARDING = 'ONBOARDING';
