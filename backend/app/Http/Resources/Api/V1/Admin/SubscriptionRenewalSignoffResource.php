...
/**
 * @mixin SubscriptionRenewalSignoff
 *
 * Sprint 24 — presents a subscription renewal sign-off. No secrets are exposed.
 */
class SubscriptionRenewalSignoffResource extends JsonResource
{
    /**
