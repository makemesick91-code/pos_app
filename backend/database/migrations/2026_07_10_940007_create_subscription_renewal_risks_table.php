...
/**
 * Sprint 24 — a subscription renewal risk register row. Open CRITICAL/HIGH without
 * a valid accepted risk forces NO-GO; open MEDIUM forces WATCH. Accepted risk
 * requires approver, reason and expiry; an expired accepted risk re-blocks. No
 * secrets or private customer data stored.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('subscription_renewal_risks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('subscription_renewal_risks');
    }
};
