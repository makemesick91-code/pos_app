...
<head>
    ...
    <title>Masuk · Aish POS Konsol Pemilik</title>
    ...
    <main class="login-card" role="main">
        <div class="brand">
            ...
            <span>
                ...
                <span class="brand-sub">Konsol Pemilik Bisnis</span>
            </span>
        </div>

        <h1>Masuk Pemilik Bisnis</h1>
        <p class="lead">Portal pemilik untuk memantau outlet, perangkat, langganan, dan operasional bisnis Anda.</p>
        ...
        <form method="POST" action="{{ route('owner.login.store') }}" novalidate>
            @csrf
            ...
            <div class="field">
                ...
                <span id="pw-help" class="brand-sub" style="font-size:12px;">Gunakan kata sandi yang diberikan oleh tim Aish POS.</span>
            </div>
