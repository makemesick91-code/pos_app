...
@section('content')
    <div class="breadcrumb">
        <a href="{{ route('admin.billing') }}">Penagihan</a> ·
        <a href="{{ route('admin.billing.invoices') }}">Faktur</a> ·
        {{ $inv['invoice_number'] ?? '—' }}
    </div>
    ...
    <div class="cards">
        <div class="card">
            ...
            <div class="v" style="font-size:18px;"><a href="{{ route('admin.tenants.billing', $inv['tenant_id']) }}">#{{ $inv['tenant_id'] }}</a></div>
        </div>
        <div class="card">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <p style="margin-top:var(--aish-space-lg);">
                <a class="btn-ghost" href="{{ route('admin.billing.invoices.download', $inv['id']) }}">Unduh faktur</a>
            </p>
        </div>
    </div>
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="5"><div class="empty">Belum ada permintaan pembayaran QRIS.</div></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
