...
@section('content')
    <div class="breadcrumb"><a href="{{ route('admin.billing') }}">Penagihan</a> · Faktur</div>
    <h1 class="page-title">Faktur (semua tenant)</h1>

    <form method="GET" action="{{ route('admin.billing.invoices') }}" class="filters" role="search">
        <div>
    ...
    <div class="panel">
        ...
        <div class="table-wrap">
            <table>
                <caption class="sr-only">Daftar faktur lintas tenant</caption>
                <thead>
                    <tr>
        ...
        @include('billing.partials.pager', ['paginator' => $paginator])
    </div>
@endsection
