...
/**
 * Sprint 14 — pilot release regression contract. Confirms the Sprint 0–13 API
 * surface and the release + pilot Artisan commands remain registered, so the
 * pilot RC does not silently break existing tenant/business behavior.
 */
class PilotReleaseRegressionRouteTest extends TestCase
{
    /**
    ...
    public function test_release_and_pilot_commands_are_registered(): void
    {
