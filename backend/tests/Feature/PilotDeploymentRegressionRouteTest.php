...
/**
 * Sprint 15 — pilot deployment regression contract. Confirms the Sprint 0–14 API
 * surface and the release + pilot RC/UAT + pilot deployment/field Artisan
 * commands remain registered, so the pilot deployment foundation does not
 * silently break existing tenant/business behavior.
 */
class PilotDeploymentRegressionRouteTest extends TestCase
{
    /**
    ...
    public function test_release_pilot_and_deployment_commands_are_registered(): void
    {
